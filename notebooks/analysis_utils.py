...
def load_text_data(data_dir):
  ...
  #     dtype=str,
  #     delimiter="\n")
  with open(os.path.join(data_dir, "author_map.txt"),'r') as f:
    author_map=f.readlines()
  author_map = np.array([a.rstrip('\n') for a in author_map])
  ...
  #     delimiter="\n",
  #     comments="<!-")   
  # with open(os.path.join(data_dir, "raw_documents.txt"),'r') as f:
  #   raw_documents=f.readlines()
  # raw_documents = np.array([d.rstrip('\n') for d in raw_documents])

  # return counts, vocabulary, author_indices, author_map, raw_documents
  return counts, vocabulary, author_indices, author_map
